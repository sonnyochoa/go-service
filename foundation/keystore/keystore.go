...
// New constructs and empty KeyStore ready for use.
func New() *KeyStore {
	return &KeyStore{
...
// PrivateKey searches the keystore for a given kid and returns
// the private key
...
// PublicKey searches the keystore for a given kid and returns
// the public key
