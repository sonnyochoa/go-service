...
func run(log *zap.SugaredLogger) error {
	...
	// Construct a key store based on the key files stored
	...
	debugMux := handlers.Mux(build, log, db)
	...
	// Make a channel to listen for the errors coming from the listener. Use a buffered
	// channel so the goroutine can exit if we don't collect this error.
